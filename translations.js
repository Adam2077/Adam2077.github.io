const translations = {
    cz: {
        // Meta
        page_title: "Adam Kalivoda - Full-Stack Web Developer & CNC Specialista",
        meta_description: "Portfolio Adama Kalivody, specialisty propojujícího svět full-stack webového vývoje s precizním CNC programováním. Nabízím komplexní řešení od návrhu webových aplikací a správy IT infrastruktury až po 3D modelování a tvorbu G-kódu.",

        // Navigation
        nav_about: "O mně",
        nav_webdev: "Vývoj webu",
        nav_cnc: "CNC",
        nav_network: "Správa sítí",
        nav_contact: "Kontakt",
    ...
    en: {
        // Meta
        page_title: "Adam Kalivoda - Full-Stack Web Developer & CNC Specialist",
        meta_description: "The portfolio of Adam Kalivoda, a specialist who bridges the world of full-stack web development with precision CNC programming. I offer comprehensive solutions ranging from web application design and IT infrastructure management to 3D modeling and G-code creation.",

        // Navigation
        nav_about: "About Me",
        nav_webdev: "Web Development",
        nav_cnc: "CNC",
        nav_network: "Network Administration",
        nav_contact: "Contact",
